...
def test_phone_numbers():
    assert (
        PrivacyAnalyzer(
            "Here's a phone number: +972584932014 and another one: (212)456-7890"
...
def test_emails():
    assert (
        PrivacyAnalyzer(
            "Here's an email: itai@monalabs.io and another one: flsdakjflkjsa@gmail.com"
        ).get_emails_count()
        == 2
    )
...
def test_other_phone_numbers():
    assert (
        PrivacyAnalyzer(
            ...
            (
                PrivacyAnalyzer(
                    "Here's a different phone number: +972584332014 an existing one: (212)456-7890"
                ),
...
def test_other_emails():
    assert (
        PrivacyAnalyzer(
            ...
            (
                PrivacyAnalyzer(
                    "Here's a different email: flasdkjfg@gmail.com an existing one: flsdakjflkjsa@gmail.com"
                ),
                PrivacyAnalyzer(
